...
raxmlHPC-PTHREADS-AVX -T 8 -f a -m GTRGAMMA -p 618 -N 2 -x 309 -s AllBears.aln -n AllBearTree -w /project/inbre-train/inbre006/molb4485/Eckhardt_Phylo/BearTrees -o GiantPanda
